...
export function SteamModal({
  ...
  return createPortal(
    ...
    >
      ...
      {/* Layer 2-6: Steam Field with radial gradients (z-index: 1002-1008) */}
      <SteamField
        isOpen={!isClosing}
        density={actualDensity}
      />

      {/* Content Panel - z-index: 1007 (below clearing steam) */}
      <ContentPanel>
        {children}
      </ContentPanel>

      {/* Panel Header - z-index: 1006 (below clearing steam) */}
