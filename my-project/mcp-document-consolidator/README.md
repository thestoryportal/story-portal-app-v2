...
├─────────────────────────────────────────────────────────────────┤
│  Storage                                                         │
│  ├── PostgreSQL           - Documents, claims, sections          │
...
└────────┬────────┘
         │
         ▼
   Stored in PostgreSQL + Elasticsearch + Neo4j
```
...
- Embeddings (vectors indexed in Elasticsearch)
...
└────────┬───────────┘
         ...
         ▼
┌────────────────────┐
│ Embedding Search   │ → Query Elasticsearch for similar sections
└────────┬───────────┘
         │
         ▼
┌────────────────────┐
...
docker-compose up -d  # Starts PostgreSQL, Elasticsearch, Neo4j
```
...
| `ELASTICSEARCH_INDEX` | No | `document_sections` | Index name |
