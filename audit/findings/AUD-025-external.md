...
./platform/src/L12_nl_interface/config/settings.py:273:        # Must start with http:// or https://
./platform/src/L12_nl_interface/config/settings.py:274:        if not v.startswith(("http://", "https://")):
./platform/src/L12_nl_interface/config/settings.py:275:            raise ValueError(f"Base URL must start with http:// or https://: {v}")
...
./platform/scripts/venv/lib/python3.14/site-packages/sqlalchemy/dialects/oracle/cx_oracle.py:283:<https://www.oracle.com/database/technologies/faq-nls-lang.html>`_ environment
./platform/scripts/venv/lib/python3.14/site-packages/sqlalchemy/dialects/oracle/cx_oracle.py:300:`Characters Sets and National Language Support (NLS) <https://cx-oracle.readthedocs.io/en/latest/user_guide/globalization.html#globalization>`_.
./platform/scripts/venv/lib/python3.14/site-packages/sqlalchemy/dialects/oracle/cx_oracle.py:304:    `Characters Sets and National Language Support (NLS) <https://cx-oracle.readthedocs.io/en/latest/user_guide/globalization.html#globalization>`_
...
./platform/services/mcp-context-orchestrator/node_modules/uri-js/._yarn.lock
...
./my-project/node_modules/webgl-constants/yarn.lock
./my-project/node_modules/uri-js/yarn.lock
