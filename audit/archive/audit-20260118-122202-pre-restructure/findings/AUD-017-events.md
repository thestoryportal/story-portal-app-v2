...
./platform/src/L09_api_gateway/services/event_publisher.py:91:            if self.event_store is not None:
./platform/src/L09_api_gateway/services/event_publisher.py:92:                await self.event_store.publish_event(event)
./platform/src/L09_api_gateway/services/event_publisher.py:126:        if self.event_store is not None:
./platform/src/L09_api_gateway/services/event_publisher.py:127:            await self.event_store.publish_audit_event(event)
./platform/src/L09_api_gateway/services/event_publisher.py:212:        if self.event_store is not None:
./platform/src/L09_api_gateway/services/event_publisher.py:213:            await self.event_store.publish_event(event)
./platform/src/L09_api_gateway/services/event_publisher.py:232:        if self.event_store is not None:
./platform/src/L09_api_gateway/services/event_publisher.py:233:            await self.event_store.publish_event(event)
...
## Event Table Contents (sample)
 id | event_type | aggregate_type | aggregate_id | payload | metadata | created_at | version 
----+------------+----------------+--------------+---------+----------+------------+---------
(0 rows)
