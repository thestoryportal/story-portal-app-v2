...
./platform/src/L09_api_gateway/gateway.py:261:                        request_id=f"req-{context.trace_id}-{context.span_id}",
./platform/src/L09_api_gateway/gateway.py:263:                        span_id=context.span_id,
./platform/src/L09_api_gateway/gateway.py:329:        span_id = uuid.uuid4().hex[:16]
./platform/src/L09_api_gateway/gateway.py:348:            span_id=span_id,
